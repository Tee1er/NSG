...
/**A couple useful functions that I can't be bothered to think about */
...
let gameState = {
} //gameState object contains, stuff, I guess about the game state. get it?
...
class Agent {
    constructor() {
        /**Generate a unique ID (not a UUID, there's only ~1K agents to deal with) */
        for (let i = 0; i < 6; i++) {
            this.agentID = Math.floor(Math.random*10);
        }
